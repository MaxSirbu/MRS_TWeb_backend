...
public class PlanActivationActions(ApplicationDbContext context) : IPlanActivationActions
{
    ...
    private static PlanActivationResponseDto MapToDto(PlanActivation pa) => new()
    {
        Id = pa.Id,
